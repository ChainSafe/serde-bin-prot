...
fn get_test_cases() -> Vec<([u8; 8], f64)> {
	vec![
	    ([0x3c, 0xb0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], 2.2204460492503131E-16),
	    ([0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], INFINITY),
	    ([0x7f, 0xef, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff], 1.7976931348623157E+308),
	    ([0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], INFINITY),
	    ([0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], 2.2250738585072014E-308),
	    ([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01], 4.94065645841247E-324),
